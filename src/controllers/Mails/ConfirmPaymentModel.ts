const confirmPayModel = (user: any, amount: any) => {
    ...
    <v:fill type="tile" color="#deeee3"></v:fill>
    </v:background>
    <![endif]-->
    ...
    <tr>
    <td align="center">
    <table class="es-content-body" style="background-color: #f8edeb" width="600" cellspacing="0" cellpadding="0" bgcolor="#f8edeb" align="center">
    <tr>
    <td class="es-p40t es-p40b es-p20r es-p20l" align="left" bgcolor="#333333" style="background-color: #333333">
    <table cellpadding="0" cellspacing="0" width="100%">
    <tr>
    <td width="560" align="left">
    <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
    <tr>
    <td align="center" class="es-p10b es-m-txt-c"><h1 style="font-size: 50px;color: #ffffff">THANK YOU!</h1></td>
    </tr>
    <tr>
    <td align="center" class="es-p20" style="font-size: 0px"><a target="_blank" 
      href="https://exquisite-brigadeiros-cc493c.netlify.app/"><amp-anim class="adapt-img" 
      src="https://i.ibb.co/gMPR2fW/Dise-o-sin-t-tulo.gif" alt="ThankYou" 
      style="display: block" height="160" title="ThankYou" width="200" layout="responsive" >
    </amp-anim></a></td>
    </tr>
    <tr>
    ...
    <tr>
    <td align="center" class="es-p10t"><p style="color: #9c9c9c">We toast for you!<br>
      &nbsp; &nbsp;<a target="_blank" style="color: #9c9c9c;text-decoration: underline" 
      href="https://exquisite-brigadeiros-cc493c.netlify.app/">The Wines Supply Team</a>.</p>
    </td>
    </tr>
    </table></td>
    </tr>
                  ...
                  <tr>
                   <td align="center" style="font-size:0">
                    <table class="es-table-not-adapt es-social" cellspacing="0" cellpadding="0" role="presentation">
                      <tr>
                       <td class="es-p10r" valign="top" align="center"><a target="_blank" href="https://www.facebook.com/">
                        <img title="Facebook" src="https://i.ibb.co/cyrK4mP/facebook-circle-white.png" alt="Fb" width="24" height="24"></img></a></td>
                       <td class="es-p10r" valign="top" align="center"><a target="_blank" href="https://www.twitter.com/">
                        <img title="Twitter" src="https://i.ibb.co/PF8kNp0/twitter-circle-white.png" alt="Tw" width="24" height="24"></img></a></td>
                       <td class="es-p10r" valign="top" align="center"><a target="_blank" href="https://www.instagram.com/">
                        <img title="Instagram" src="https://i.ibb.co/X82tfVg/instagram-circle-white.png" alt="Inst" width="24" height="24"></img></a></td>
                       <td valign="top" align="center"><a target="_blank" href="https://www.youtube.com/">
                        <img title="Youtube" src="https://i.ibb.co/LdDDMQK/youtube-circle-white.png" alt="Yt" width="24" height="24"></img></a></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
